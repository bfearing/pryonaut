      ...
      <div className="flex space-x-2">
        {/* <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-[150px]">
            ...
            <DropdownMenuCheckboxItem
              ...
              checked={view[0] === "Vertical"}
              onCheckedChange={(value) => view[1]("Vertical")}
            >
              Vertical
            </DropdownMenuCheckboxItem>
            <DropdownMenuCheckboxItem
              className="capitalize"
              checked={view[0] === "Horizontal"}
              onCheckedChange={(value) => view[1]("Horizontal")}
            >
              Horizontal
            </DropdownMenuCheckboxItem>
          </DropdownMenuContent>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-[150px]">
            ...
            <DropdownMenuCheckboxItem
              className="capitalize"
              checked={layout[0] === "Timeline"}
              onCheckedChange={(value) => layout[1]("Timeline")}
            >
              Timeline
            </DropdownMenuCheckboxItem>
            <DropdownMenuCheckboxItem
